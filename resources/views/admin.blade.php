    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Dashboard Admin
                    <div class="page-title-subheading">Dashboard ini berfungsi sebagai tempat pengelolaan oleh admin.
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card mb-3 widget-content bg-midnight-bloom" >
                <div class="widget-content-wrapper text-white" href="{{url('admin/kelas')}}">
                    <div class="widget-content-left">
                        <div class="widget-heading">Kelas</div>
                        <div class="widget-subheading">Jumlah Kelas</div>
                    </div>
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white"><span>{{$kelas->count()}}</span></div>
                    </div>
                </div>
            </div>
        </div>
